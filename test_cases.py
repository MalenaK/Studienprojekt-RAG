...
def test_case_101():
    return test_model("A game of Basketball is played by how many teams?", "2")


def test_case_101_complement():
    return test_model("A game of Basketball is played by how many teams?", "10")
...
def test_case_201():
    return test_model("How thick is the hull armor?", "1 inch")

def test_case_201_complement():
    return test_model("How thick is the hull armor?", "15 inch")


def test_case_202():
    return test_model("What is the maximum sustained speed on a hard road?", "26 mph")

def test_case_202_complement():
    return test_model("What is the maximum sustained speed on a hard road?", "26 kmh")

def test_case_203():
    return test_model("What range does the voltmeter have?", "16 to 32 volts")

def test_case_203_complement():
    return test_model("What range does the voltmeter have?", "6 to 62 volts")

def test_case_204():
    return test_model("Is the spark control automatic?", "Yes")

def test_case_204_complement():
    return test_model("Is the spark control automatic?", "No")

def test_case_205():
    return test_model("What is the rated horsepower for the engine?", "500 at 2600 rpm")

def test_case_205_complement():
    return test_model("What is the rated horsepower for the engine?", "250 at 2600 rpm")

def test_case_206():
    return test_model("What is the weight without armament, fuel or crew?", "59560 lb")

def test_case_206_complement():
    return test_model("What is the weight without armament, fuel or crew?", "59560 kg")

def test_case_207():
    return test_model("What guns are part of the combination turret mount?", "1 gun, 75-mm, M3 and 1 gun, machine, cal. .30, M1919A4")

def test_case_207_complement():
    return test_model("What guns are part of the combination turret mount?", "1 gun, 90-mm, M4 and 1 gun, machine, cal. .50, M2-Browning")

def test_case_208():
    return test_model("How many degrees can the turret be rotated?", "360")

def test_case_208_complement():
    return test_model("How many degrees can the turret be rotated?", "300")

def test_case_209():
    return test_model("How to stop the engine?", "After completing a run, the engine must be allowed to"
...
def test_case_209_complement():
    return test_model("How to stop the engine?", "Just turn it off by taking out the key")


def test_case_210():
    return test_model("What is the overall length?", "232 1/2-in")

def test_case_210_complement():
    return test_model("What is the overall length?", "40 meters")
...
def test_case_301():
    return test_model("What was the real gdp of Germany in 2023?", "5.23 trillion")


def test_case_301_complement():
    return test_model("What was the real gdp of Germany in 2023?", "6 trillion")
...
def test_case_303():
    return test_model("Who is the biggest import partner of Germany?", "China")

def test_case_303_complement():
    return test_model("Who is the biggest import partner of Germany?", "France")

def test_case_304():
    return test_model("Who is the head of government?", "Olaf Scholz")

def test_case_304_complement():
    return test_model("Who is the head of government?", "Angela Merkel")

def test_case_305():
    return test_model("Who is the chief of state?", "Frank-Walter Steinmeier")

def test_case_305_complement():
    return test_model("Who is the chief of state?", "Pierre Danke")

def test_case_306():
    return test_model("What is the population growth?", "-0.12%")

def test_case_306_complement():
    return test_model("What is the population growth?", "0.14%")

def test_case_307():
    return test_model("What is the total population?", "84119100")

def test_case_307_complement():
    return test_model("What is the total population?", "22200000")

def test_case_308():
    return test_model("What is the total area of Germany? How much land and how water does it consist of?", "totaL: 357022 sq km, land: 348672 sq km, water: 8350 sq km")

def test_case_308_complement():
    return test_model("What is the total area of Germany? How much land and how water does it consist of?", "totaL: 100000 sq km, land: 1000 sq km, water: 99000 sq km")


def test_case_309():
    return test_model("What are the 3 largest ethnic groups in Germany?", "1. German (85,4%), 2.Turkish(1.8%), 3.Ukrainian(1.4%)")
...
positive_test_cases = germany_positive_test_cases#fiba_positive_test_cases + sherman_positive_test_cases + germany_positive_test_cases
negative_test_cases = germany_positive_test_cases#fiba_negative_test_cases + sherman_negative_test_cases + germany_negative_test_cases